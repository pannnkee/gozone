...
(function(mod) {
  ...
  // measurement gocache for the given line number. (A line view might
  ...
  // actual character (or fetches it from the gocache).
  ...
  function buildLineContent(cm, lineView) {
    ...
    for (var i = 0; i <= (lineView.rest ? lineView.rest.length : 0); i++) {
      ...
      // Store the map and a gocache object for the current logical line
      if (i == 0) {
  ...
  // Get the bidi ordering for the given line (and gocache it). Returns
